...
public class MultiplayerInstanceActivity extends Activity  {
    ...
    OnClickListener To_Main_Menu_list = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            MultiplayerInstanceActivity.this.finish();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gamePanel = new MultiplayerGamePanel(getApplicationContext(), this,widthS, heightS);
        ...
        MainMusic = MediaPlayer.create(MultiplayerInstanceActivity.this, R.raw.music);
